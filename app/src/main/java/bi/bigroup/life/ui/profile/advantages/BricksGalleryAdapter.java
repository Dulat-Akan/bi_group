...
class BricksGalleryAdapter extends RecyclerViewBaseAdapter {
    private static final int LAYOUT_ID = R.layout.adapter_advantages_bricks;

    private Context context;
    private List<BricksGallery> data;
    private Callback callback;

    BricksGalleryAdapter(Context context) {
