...
class PlansAdapter<VH extends RecyclerView.ViewHolder>
        extends RecyclerView.Adapter<VH> implements StickyRecyclerHeadersAdapter<RecyclerView.ViewHolder> {
    private static final int ITEM_LAYOUT_ID = R.layout.adapter_plans;
    private static final int ITEM_HEADER_LAYOUT_ID = R.layout.adapter_plans_header;
    private List<Plans> data = Collections.emptyList();

    PlansAdapter() {
        setHasStableIds(true);
    }

    public void setData(List<Plans> newList) {
