...
class ResultsAdapter<VH extends RecyclerView.ViewHolder>
        extends RecyclerView.Adapter<VH> implements StickyRecyclerHeadersAdapter<RecyclerView.ViewHolder> {
    private static final int ITEM_LAYOUT_ID = R.layout.adapter_results;
    private static final int ITEM_HEADER_LAYOUT_ID = R.layout.adapter_results_header;
    private List<Results> data = Collections.emptyList();

    ResultsAdapter() {
        setHasStableIds(true);
    }

    public void setData(List<Results> newList) {
